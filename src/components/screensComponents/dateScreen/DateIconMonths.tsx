...
const DateIconMonths = ({dates}: IDateIconMonths) => {
  ...
  let text: string = '';
  if (getMonth(start) == getMonth(end)) text = textMonth(getMonth(start));
  else text = textMonth(getMonth(start)) + '-' + textMonth(getMonth(end));
  return (
    <View style={{flexDirection: 'row'}}>
      ...
      <Text
        style={[
          ...
          {color: gray, textAlignVertical: 'center'},
        ]}>
        {text}
      </Text>
    </View>
